...
import PropTypes from 'prop-types';
 ...
 class PreHomeSideBar extends React.Component {
...
<div className="pre-movie-sidebar w3-bar-block" id="mySidebar">
...
<div style={{    padding: '1rem', height: '20vh'}}>
   ...
   <span><select className="pre-main-side-select">
...
export default connect(mapStateToProps,mapDispatchToProps)(PreHomeSideBar);
PreHomeSideBar.propTypes = {
}
