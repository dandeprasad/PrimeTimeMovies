...
class PXVideo extends React.Component {
  ...
  render() {
    ...
    return (
      <Row>
        <Col xs="12" sm="12" md="12" id={id} style={{padding:'0px'}}>
     
        <Row>
        <Col xs="12" sm="12" md="12" style={{padding:'0px'}}>
          <div className="px-video-captions hide" />
          <video className='my-video' {...videoProps} >
            {sources &&
              sources.map(src => (
                <source
                  key={src}
...
export default connect(mapStateToProps,mapDispatchToProps)(PXVideo);
