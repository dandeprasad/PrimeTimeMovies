...
class CurrentRunningMovies extends React.Component {
...
<h5 style={{marginLeft:"40px"}}>Current Movies</h5>
         </Col>
     </Row>
...
export default connect(mapStateToProps,mapDispatchToProps)(CurrentRunningMovies);
CurrentRunningMovies.propTypes = {
