...
const store = createStore(combineReducers({math:math,flashMessages:flashMessages,user:user,festRegisreduce:festRegisreduce,NewsArticlesreduce:NewsArticlesreduce,Pathparamsreduce:Pathparamsreduce,EventsReducer:EventsReducer,ExamsReduce:ExamsReduce,
